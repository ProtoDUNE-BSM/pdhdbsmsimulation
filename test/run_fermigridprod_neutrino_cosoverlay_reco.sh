...
export DUNESW_VERSION=v10_01_03d00
...
cp ${INPUT_TAR_DIR_LOCAL}/protodunedm_mc_simulation/srcs/pdhdbsmsimulation/example/$FCL_FILE mytmpfcl  # do a cp, not mv
rm ${INPUT_TAR_DIR_LOCAL}/protodunedm_mc_simulation/srcs/pdhdbsmsimulation/example/$FCL_FILE # This really just removes the link
...
cp ${INPUT_TAR_DIR_LOCAL}/protodunedm_mc_simulation/srcs/pdhdbsmsimulation/example/PandoraSettings_Master_ProtoDUNE_HD_Neutrino.xml ${_CONDOR_JOB_IWD}
...
lar -c ${INPUT_TAR_DIR_LOCAL}/protodunedm_mc_simulation/srcs/pdhdbsmsimulation/example/standard_detsim_protodunehd_stage1_edit.fcl -n ${NEvents} -o ${DETSIM1OUTFILENAME} -s ${G42OUTFILENAME}
rm ${G42OUTFILENAME}
# Check output was successfully produced
...
lar -c ${INPUT_TAR_DIR_LOCAL}/protodunedm_mc_simulation/srcs/dunetrigger/example/run_tpalg_taalg_tcalg.fcl -n ${NEvents} -o ${TRIGOUTFILENAME} -s ${DETSIM2OUTFILENAME}
...
lar -c ${INPUT_TAR_DIR_LOCAL}/protodunedm_mc_simulation/srcs/pdhdbsmsimulation/example/runPandoraNeutrinoMC.fcl -n ${NEvents} -o ${RECOOUTFILENAME} -s ${TRIGOUTFILENAME}
rm ${TRIGOUTFILENAME}
# Check output was successfully produced
